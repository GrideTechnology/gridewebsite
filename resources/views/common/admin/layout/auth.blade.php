...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('assets/layout/css/dashboards.min.css') }}" />
    <link type="text/css" rel="stylesheet" href="{{ asset('assets/plugins/extras/css/extras.min.css') }}" />
    <link type="text/css" rel="stylesheet" href="{{ asset('assets/plugins/chart/css/export.css') }}" />
    <link type="text/css" rel="stylesheet" href="{{ asset('assets/plugins/font-awesome-4.7.0/css/font-awesome.min.css') }}" />
    <link type="text/css" rel="stylesheet" href="{{ asset('assets/layout/css/admin-style.css') }}" />
</head>
<body>
