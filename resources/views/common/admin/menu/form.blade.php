        ...
        if($service_id =='TRANSPORT'){
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data.responseData, function(key, item) {
                        if(item.id==51){
                            var option = '<option value="' + item.id + '" selected>' + item.service_category_name+ '</option>';
                        }else{
                            var option = '<option value="' + item.id + '">' + item.service_category_name+ '</option>';
                        }
                        $("#menu_type_id").append(option);
                    });
