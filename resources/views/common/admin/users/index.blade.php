            ...
            <div class="card card-small">
                ...
                <thead>
                    <tr>
                        ...
                        <th data-value="licence_approval">Licence Approval</th>
...
$(document).ready(function() {
    ...
    table = table.DataTable( {
        ...
        "columns": [
            ...
            { "data": "licence_verified" ,render: function (data, type, row) {
                // console.log(data);
                   if(data ==1){
                        return "Verified";
                   }else{
            ...
            { "data": function (data, type, row) {
                ...
                if(data.status ==1){
                   ...
                   button +='<li><a href="javascript:;" data-id="'+data.id+'" data-value="'+data.status+'" data-sab_url="/admin/users/'+data.id+'" class="dropdown-item delete-record"><i class="fa fa-trash"></i>&nbsp;Delete</a> </li>';
                    button +='</ul> </li></div>';
