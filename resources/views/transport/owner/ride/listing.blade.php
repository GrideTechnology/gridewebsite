...
<div class="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation1 css-16xjay3">
                        ...
                        <table class="MuiTable-root MuiTable-stickyHeader css-cly2df">
                          <thead class="MuiTableHead-root css-1wbz3t9">
                            <tr class="MuiTableRow-root MuiTableRow-head css-1lzq4x8">
                              <th class="MuiTableCell-root MuiTableCell-head MuiTableCell-stickyHeader MuiTableCell-sizeMedium jss556 jss570 css-vfeanu" scope="col">Year, Make, Model</th>
                              <th class="MuiTableCell-root MuiTableCell-head MuiTableCell-stickyHeader MuiTableCell-sizeMedium jss556 jss570 css-vfeanu" scope="col">VIN</th>
                              <th class="MuiTableCell-root MuiTableCell-head MuiTableCell-stickyHeader MuiTableCell-sizeMedium jss556 jss570 css-vfeanu" scope="col">Daily</th>
                              <th class="MuiTableCell-root MuiTableCell-head MuiTableCell-stickyHeader MuiTableCell-sizeMedium jss556 jss570 css-vfeanu" scope="col">Protection</th>
                              <th class="MuiTableCell-root MuiTableCell-head MuiTableCell-stickyHeader MuiTableCell-sizeMedium jss556 jss570 css-vfeanu" scope="col">Updated</th>
                              <th class="MuiTableCell-root MuiTableCell-head MuiTableCell-stickyHeader MuiTableCell-sizeMedium jss556 jss570 css-vfeanu" scope="col">Status</th>
                              <th class="MuiTableCell-root MuiTableCell-head MuiTableCell-stickyHeader MuiTableCell-sizeMedium jss556 jss570 css-vfeanu" scope="col">Action</th>
                            </tr>
                          </thead>
                        ...
                        <!-- <td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv"><i class="fa fa-edit"></i></td> -->
...
function getCarStatus(id){
    url = getBaseUrl() + "/user/transport/carstatus";
    var response = '';
    $.ajax({
        type:"POST",
        url: url,
        ...
        success:function(data){
            $('table tr').last().find('.status').text(data.message);
        }
    });
}
...
function getcarList(){
    var url = getBaseUrl() + "/user/transport/owner-cars";
    ...
    success:function(data){
            ...
            vehicles.forEach(function(item, index){
               ...
               if(item.status==0){
                ...
                vehicleList+='<tr class="MuiTableRow-root jss561 jss562 css-1lzq4x8"><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv"><div style="display: flex; align-items: center;"><div class="MuiAvatar-root MuiAvatar-circular css-1o5gwq2" style="width: 30px; height: 30px;"><img alt="Driver" src="'+item.right+'" class="MuiAvatar-img css-1hy9t21"></div><span style="margin-left: 16px;">'+item.model+'</span></div></td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv">'+item.vin+'</td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv">$'+item.daily_charges+'</td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv">'+protection+'</td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv">'+item.updated_at+'</td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv"><div style="display: flex; align-items: center;"><div class="jss575 jss576"></div><p class="MuiTypography-root MuiTypography-body2 css-r6zjfs status" style="margin-left: 8px;">'+status+'</p></div></td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv"><a href="{{url("/")}}/owner/edit-listing/'+item.id+'"><i class="fa fa-edit"></i></a></td></tr>';

                //getCarStatus(item.id);
            });
