                                                                          ...
                                                                          <div class="form-group">
                                                                            ...
                                                                            <div class="form-group">
                                                                              ...
                                                                              <div class="form-group">
                                                                                ...
                                                                                <h4>Capacity:</h4>
                                                                              <div class="form-group">
                                                                                  <input type="text" placeholder="Capacity" id="capacity" name="capacity">
                                                                                </div>
                                                                                <h4>Odometer:</h4>
                                                                                <div class="form-group">
                                                                                ...
                                                                                <h4>Car Description:</h4>
                                                                                  <div class="form-group">
                                                                                      <textarea placeholder="Description" id="about" name="about"></textarea>
                                                                                    </div>
                                                                    </div>
                                                                ...
                                                                80% mileage overage reimbursement
                                                                    ...
                                                                    <div class="tab">
                                                                        ...
                                                                        <hr>
                                                                            ...
                                                                            <h4>Daily Charges:</h4>
                                                                            <div class="form-group">
                                                                                <input type="text" placeholder="ex. 1000" id="daily_charges" name="daily_charges">
                                                                              </div>

                                                                            <h4>Booking Fee:</h4>
                                                                            <div class="form-group">
                                                                                <input type="text" placeholder="ex. 1000" id="booking_fee" name="booking_fee">
                                                                              </div>

                                                                             <h4>Cancellation Fee:</h4>
                                                                            <div class="form-group">
                                                                                <input type="text" placeholder="ex. 1000" id="cancellation_charges" name="cancellation_charges">
                                                                              </div>

                                                                             <h4>Insurance Fee:</h4>
                                                                            <div class="form-group">
                                                                                <input type="text" placeholder="ex. 1000" id="insurance_charges" name="insurance_charges">
                                                                              </div>

                                                                             <h4>Sales Tax %:</h4>
                                                                            <div class="form-group">
                                                                                <input type="text" placeholder="ex. 1000" id="sales_tax" name="sales_tax">
                                                                              </div>
                                                                        ...
                                                                        <div class="tab">
                                                                            ...
                                                                            <div class="tab">
                                                                                ...
                                                                                <div>
                                                                                    <input type="date" name="registration_exp" id="registration_exp">
                                                                                </div>
                                                                                <h4>Insurance:</h4>
                                                                                <input type="file" id="insurance" name="insurance" accept="image/*">
                                                                                <div>
                                                                                    <input type="date" name="insurance_exp" id="insurance_exp">
                                                                                </div>
                                                                                <h4>Inspection:</h4>
                                                                                <input type="file" id="inspection" name="inspection" accept="image/*">
                                                                                <div>
                                                                                    <input type="date" name="inspection_exp" id="inspection_exp">
                                                                                </div>
                                                                    ...
                                                                    <input type="hidden" name="id" id="carid" value="{{$id}}">
...
<script>
        ...
        function validateForm() {
          ...
          if(currentTab<4 && currentTab>5){
            ...
            if(currentTab==4){
                ...
                var isimg = $('#right').closest('img').attr('src');
                if (rightimg==='undefined' && isimg=='') {
                  // add an "invalid" class to the field:
    ...
    <script>
        function updateRecord(){
            ...
            $.ajax({
                url: getBaseUrl() + "/user/transport/updatecar",
                headers: {
                ...
                success: function(data){
                    ...
                    window.location.href="{{url('/')}}/owner/listing";
                }

            });
        }

        var url = getBaseUrl() + "/user/transport/cars-type-list";
        ...
        $.ajax({
            ...
            success:function(data){
                    ...
                    vehicleType.forEach(function(item, index){
                        ...
                        vehicleTypeList+='<option value="'+item.id+'">'+item.name+'</option>';
                    });

                    $('#type').append(vehicleTypeList);
            }
        });
        $(function(){
...
$.ajax({
    ...
    success:function(data){
            ...
            var carImages = data.responseData.carimages[0];

            $('#pickup_address').val(carData.pickup_address);
            $('#vin').val(carData.vin);
            $('#make').val(carData.make);
            $('#model').val(carData.model);
            $('#year').val(carData.year);
            $('#color').val(carData.color);
            $('#capacity').val(carData.capacity);
            $('#odometer').val(carData.odometer);
            $('#plate_number').val(carData.plate_number);
            $('#about').val(carData.about);
            
            $('#milleage_allowed').val(carData.milleage_allowed);
            $('#daily_charges').val(carData.daily_charges);
            $('#booking_fee').val(carData.booking_fee);
            $('#cancellation_charges').val(carData.cancellation_charges);
            $('#insurance_charges').val(carData.insurance_charges);
            $('#sales_tax').val(carData.sales_tax);

            $('#registration_exp').val(carData.registration_exp);
            $('#insurance_exp').val(carData.insurance_exp);
            $('#inspection_exp').val(carData.inspection_exp);

            if(carImages.front!=null){
                $('#front').after('<img src="'+carImages.front+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.back!=null){
                $('#back').after('<img src="'+carImages.back+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.left!=null){
                $('#left').after('<img src="'+carImages.left+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.right!=null){
                $('#right').after('<img src="'+carImages.right+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.front_left_tire!=null){
                $('#front_left_tire').after('<img src="'+carImages.front_left_tire+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.back_left_tire!=null){
                $('#back_left_tire').after('<img src="'+carImages.back_left_tire+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.front_right_tire!=null){
                $('#front_right_tire').after('<img src="'+carImages.front_right_tire+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.back_right_tire!=null){
                $('#back_right_tire').after('<img src="'+carImages.back_right_tire+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.left_front_seat_interior!=null){
                $('#left_front_seat_interior').after('<img src="'+carImages.left_front_seat_interior+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.right_front_seat_interior!=null){
                $('#right_front_seat_interior').after('<img src="'+carImages.right_front_seat_interior+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.left_back_seat_interior!=null){
                $('#left_back_seat_interior').after('<img src="'+carImages.left_back_seat_interior+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.right_back_seat_interior!=null){
                $('#right_back_seat_interior').after('<img src="'+carImages.right_back_seat_interior+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.left_front_door!=null){
                $('#left_front_door').after('<img src="'+carImages.left_front_door+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.right_front_door!=null){
                $('#right_front_door').after('<img src="'+carImages.right_front_door+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.left_back_door!=null){
                $('#left_back_door').after('<img src="'+carImages.left_back_door+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.right_back_door!=null){
                $('#right_back_door').after('<img src="'+carImages.right_back_door+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.back_interior!=null){
                $('#back_interior').after('<img src="'+carImages.back_interior+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.trunk!=null){
                $('#trunk').after('<img src="'+carImages.trunk+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carImages.dashboard!=null){
                $('#dashboard').after('<img src="'+carImages.dashboard+'" style="width:100px;float: right;background: #fff;">');
            }


            if(carData.registration!=null){
                $('#registration').after('<img src="'+carData.registration+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carData.insurance!=null){
                $('#insurance').after('<img src="'+carData.insurance+'" style="width:100px;float: right;background: #fff;">');
            }
            if(carData.inspection!=null){
                $('#inspection').after('<img src="'+carData.inspection+'" style="width:100px;float: right;background: #fff;">');
            }
            

            if(carData.protection==1){
                var protection="basic";
            }else{
                var protection="standard";
            }

            //$('#protection').val(carData.pickup_address);

            $('#type option').each(function(){
                var data=$(this).val();

                if(data==carData.type){
                    $(this).prop("selected", true);
                }
            });

            $('input[name="protection"]').each(function(){
                var data=$(this).val();
