...
.MuiTableCell-root .btn-accept, .MuiTableCell-root .btn-danger{
...
function getcarList(){
    var url = getBaseUrl() + "/user/transport/owner-bookings";
...
$.ajax({
    ...
    success:function(data){
            ...
            vehicles.forEach(function(item, index){
               ...
               if(item.status==0){
                    status='Request';
                    isnew='<span class="new-request">New</span>';
                    action = '<button class="btn btn-accept mr-1" type="button" onclick="changestatus('+item.id+', 1)">Accept</button><button class="btn btn-danger" type="button" onclick="changestatus('+item.id+', 7)">Decline</button>';
               }else if(item.status==1){
                    status='Accepted';
                    action = '<button class="btn btn-danger" type="button" onclick="changestatus('+item.id+', 4)">Cancel</button>';
                ...
                vehicleList+='<tr class="MuiTableRow-root jss561 jss562 css-1lzq4x8"><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv"><div style="display: flex; align-items: center;"><div class="MuiAvatar-root MuiAvatar-circular css-1o5gwq2" style="width: 30px; height: 30px;"><img alt="Driver" src="'+item.right+'" class="MuiAvatar-img css-1hy9t21"></div><span style="margin-left: 16px;">'+item.model+'</span>'+isnew+'</div></td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv">'+item.vin+'</td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv">$'+item.total_amount+'</td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv">'+protection+'</td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv">'+item.booking_start_date+'</td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv">'+item.booking_end_date+'</td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv"><div style="display: flex; align-items: center;"><div class="jss575 jss576"></div><p class="MuiTypography-root MuiTypography-body2 css-r6zjfs" style="margin-left: 8px;">'+status+'</p></div></td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv">'+action+'</td></tr>';
            });
...
function changestatus(id, status){
    ...
    $.ajax({
        url: getBaseUrl()+"/user/transport/changebookingstatus",
        type: "POST",
        headers: {
            Authorization: "Bearer " + getToken("owner")
        },
