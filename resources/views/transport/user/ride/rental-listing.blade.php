...
<div class="popupbox">
    <div class="confirm-box">
      <p>Are you sure? Cancellation Fee: $<span class="cancel-charges"></span> with the amount that would be due</p>
      <a href="javascript:void(0)" id="cancel-confirm" title="Yes">Yes</a>
      <a href="javascript:void(0)" id="cancel-decline" title="No">No</a>
    </div>
</div>
@stop
@section('scripts')
...
$.ajax({
    ...
    success: function(response){
        ...
        $('.cancel-charges').text(response.cancellation_fee);
    }
});
    ...
    $.ajax({
        ...
        success:function(data){
                ...
                vehicles.forEach(function(item, index){
                   ...
                   var status='';
                   var action = '<button type="button" class="btn btn-danger" title="cancel" onclick="changestatus('+item.id+', 4)">Cancel</button>';
                   if(item.status==0){
                        status='Pending';
                        ...
                        var amount=$('.cancel-charges').text();
                   }
                    ...
                    vehicleList+='<tr class="MuiTableRow-root jss561 jss562 css-1lzq4x8"><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv"><div style="display: flex; align-items: center;"><div class="MuiAvatar-root MuiAvatar-circular css-1o5gwq2" style="width: 30px; height: 30px;"><img alt="Driver" src="'+item.right+'" class="MuiAvatar-img css-1hy9t21"></div><span style="margin-left: 16px;">'+item.model+'</span></div></td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv">'+item.vin+'</td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv">$'+amount+'</td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv">'+protection+'</td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv">'+item.pickup_address+'</td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv"><div style="display: flex; align-items: center;"><div class="jss575 jss576"></div><p class="MuiTypography-root MuiTypography-body2 css-r6zjfs" style="margin-left: 8px;">'+status+'</p></div></td><td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeMedium css-1l20mnv">'+action+'</td></tr>';
                });
