              ...
              <div class="form-row">
				...
				<div class="form-row">
                    <div class="form-group col-md-6 refund_amount common">
						...
						<input class="form-control decimal " type="text"  name="refund_amount" id="refund_amount" min="0">
						<span>Refundable maximum value is <span id="refund_amount_id"></span></span>
					</div>
				</div>
                <div class="form-row">
		...
		$.ajax({
            ...
            success: function(data) {
				...
				$("#dispute_type").val(data.responseData.dispute_type.charAt(0).toUpperCase()+data.responseData.dispute_type.slice(1));
				 ...
				 $("#refund_amount").attr({ "max" : data.responseData.refund_amount,"min" : 0 });
				 $("#refund_amount_id").html(data.responseData.refund_amount);
