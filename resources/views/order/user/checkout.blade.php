                        ...
                        <div class="cart-totals-fields">
                           ...
                           <table class="table">
                              <tbody>
                                 ...
                                 <tr>
                                    <td class="pl-0 b-0 w-100">
                                       <select class="form-control w-100" name="payment_mode" id="payment_mode" >
                                 ...
                                 <tr class="mycard d-none">
                                    <td class="pl-0 b-0 w-100">
                                       <select class="form-control w-100" name="card_id" id="card_id" >
                                 ...
                                 <tr>
                                    <td class="pl-0 b-0 w-100">
                                       <select class="form-control w-100" name="order_type" id="order_type" >
