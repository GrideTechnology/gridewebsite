...
Route::get('/permission_list/{id}/token/{token}', function ($id, $token) {
    $client = new \GuzzleHttp\Client();    //env('BASE_URL') 
    $result = $client->post(config('gride.BASE_URL') . '/api/v1/admin/permission_list', [
...
Route::view('/owner', 'common.admin.owner.index');

Route::view('/owner/create', 'common.admin.owner.form');
Route::get('/owner/{id}/edit', function ($id) {
    return view('common.admin.owner.form', compact('id'));
});

Route::view('/blog', 'common.admin.blog.index');
Route::view('/blog/create', 'common.admin.blog.form');
Route::get('/blog/{id}/edit', function ($id) {
    return view('common.admin.blog.form', compact('id'));
});
...
Route::get('/delivery-charges', function ($type='dispatcher') {
    $type =ucfirst($type);
    return view('common.admin.deliverycharges.index', compact('type'));
});

Route::get('/delivery-charges/{id}/edit', function ($id) {
    return view('common.admin.deliverycharges.form', compact('id'));
});

Route::get('/restaurant-users', function ($type='dispatcher') {
    $type =ucfirst($type);
    return view('common.admin.Restaurant.index', compact('type'));
});
