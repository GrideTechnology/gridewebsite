            ...
            <div class="col-xs-12">
                ...
                <div class="tab-content pricing-nav nav-wrapper" id="nav-tabContent">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="base_distance"> {{ __('Base Distance (0 Miles)') }}</label>
                        ...
                        <div class="form-group col-md-6">
                            <label for="per_miles"> {{ __('Unit Distance Pricing (0 Miles)') }}</label>
                            <input class="form-control" type="number" value="" name="per_miles" id="price" placeholder="Unit Distance Price" min="0">
                            <span class="txt_clr_4"><i>  {{ __('PMiles (Per Miles), TMiles (Total Miles)') }}</i></span>
                        </div>
