               ...
               <form class="trip-frm2 w-100">
                  <div class="col-md-12 col-sm-12 col-lg-12 p-0 dis-reverse">
                     ...
                     <div id="ride-book" class="col-sm-12 col-md-12 col-lg-5 p-0 form-section d-none">
                        ...
                        <input type="hidden" name="estimated_fare" id="fare" value="0"/>
                        @if(Helper::isDestination())
                           ...
                           <div id="estimation"></div>
                              <ul class="estimation invoice"></ul>
                                 ...
                                 <div class="row">
                                    ...
                                    <div  class="col-md-6 col-sm-12 col-xl-4 dis-end mt-2 d-sm-none d-md-none d-xl-block online is_female">
                                          <h5 class="p-0 go-online">@lang('transport.user.is_female')</h5>
                                         
                                          <label class="toggleSwitch nolabel" onclick="">
                                             <input name="is_female" value="1"id="is_female" type="checkbox"  autocomplete="off">
                                             <span>
                                                <span class="show1">@lang('transport.user.no')</span>
                                                <span class="show2">@lang('transport.user.yes')</span>
                                             </span>
...
$('#someone').on('change',function(){
   ...
   $(document).ready(function(){
     ...
     if(userSettings.id != 0) {
            ...
            success: (data, textStatus, jqXHR) => {
               ...
               if((Object.keys(data.responseData)).length > 0) {
                  ...
                  if(result.fare.estimated_fare != "") {
                     $('#fare').val(result.fare.estimated_fare);
                     estimationHtml += `<li>
      ...
      $("#book-now, #schedule-later").click(function() {
         ...
         data["estimated_fare"] = $('input[name=estimated_fare]').val();
         ...
         data["is_female"] = $('input[name=is_female]:checked').val();
   ...
   function getRideTypes() {
      // var current_latitude = 33.7675434;
      // var current_longitude = -84.5849466;
      $.ajax({
