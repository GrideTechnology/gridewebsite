            ...
            { "data": function (data, type, row) {
                ...
                if(data.status ==1){
                    ...
                    var button='<div class="input-group-btn action_group"> <li class="action_icon"> <button type="button"class="btn btn-info btn-block "data-toggle="dropdown"><i class="fa fa-ellipsis-v" aria-hidden="true" title="View"></i></button>'+
                           ...
                           button +='<li > <a class="dropdown-item status" data-id="'+data.id+'" data-value="'+data.status+'"  href="javascript:;"><i class="fa fa-expand" aria-hidden="true" title="Status">&nbsp;'+status+'</i></a></li><li><a href="javascript:;" data-id="'+data.id+'" class="dropdown-item edit"><i class="fa fa-edit"></i> Edit</a> </li><li><a href="javascript:;" data-id="'+data.id+'" data-value="'+data.status+'" data-sab_url="/admin/vehicletype/'+data.id+'" class="dropdown-item delete-record"><i class="fa fa-trash"></i>&nbsp;Delete</a> </li>';
                            button +='</ul> </li></div>';
                         return  button;  
