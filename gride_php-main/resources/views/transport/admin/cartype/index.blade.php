...
@section('title') {{ __('Cars Type') }} @stop
    ...
    <div class="main-content-container container-fluid px-4">
        <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle">{{ __('Cars Type') }}</span>
                <h3 class="page-title">{{ __('Cars Type') }} </h3>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card card-small">
                    <div class="card-header border-bottom">
                        <h6 class="m-0 pull-left">{{ __('Cars Type') }}</h6>
                    ...
                    <table id="data-table" class="table table-hover table_width display lightgallery">
                        <thead>
                            <tr>
                                ...
                                <th data-value="vehicle_name">Cars Type</th>
                                <th data-value="price">Price</th>
                                <th data-value="plate_number">Charge Type</th>
                                <th data-value="iimage">Charge Type</th>
    ...
    console.log(CryptoJSAesEncrypt('FbcCY2yCFBwVCUE9R+6kJ4fAL4BJxxjd', 'Hello World'));*/
        ...
        $(document).ready(function() {
            ...
            $('.add').on('click', function(e) {
                e.preventDefault();
                $.get("{{ url('admin/cars-type/create') }}", function(data) {
            ...
            $('body').on('click', '.edit', function(e) {
                e.preventDefault();
                $.get("{{ url('admin/cars-type/') }}/" + $(this).data('id') + "/edit", function(data) {
                    $('.crud-modal .modal-container').html("");
                    $('.crud-modal .modal-container').html(data);
                });
                $('.crud-modal').modal('show');
            ...
            table = table.DataTable({
                ...
                "ajax": {
                    "url": getBaseUrl() + "/admin/cars-type",
                    "type": "GET",
      ...
      $('body').on('click', '.delete', function() {
        ...
        var url = getBaseUrl() + "/admin/cars-type/"+id+"/delete";
        $.ajax({
            type:"delete",
            url: url,
            headers: {
      ...
      $('body').on('click', '.status', function() {
                ...
                $(".status-modal-btn")
                    ...
                    .on("click", function() {
                        ...
                        var url = getBaseUrl() + "/admin/cars-type/" + id + '/updateStatus?status=' +
                            value;
