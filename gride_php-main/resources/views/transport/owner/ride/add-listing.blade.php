...
<div class="jss131">
                                                                ...
                                                                80% mileage overage reimbursement
                                                                    ...
                                                                    <div class="tab">
                                                                        ...
                                                                        <hr>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <input type="number" placeholder="ex. 1000" id="milleage_allowed" name="milleage_allowed">
                                                                              </div>

                                                                            <h4>Daily Charges:</h4>
                                                                            <div class="form-group">
                                                                                <input type="number" placeholder="ex. 1000" id="daily_charges" name="daily_charges">
                                                                              </div>

                                                                            <h4>Weekly Charges:</h4>
                                                                            <div class="form-group">
                                                                                <input type="number" placeholder="ex. 1000" id="weekly_charges" name="weekly_charges">
                                                                            </div>
 ...
 -->
                                                                              <h5>Estimated Earnings (Daily) = $<span class="daily"></span></h5>
                                                                              <h5>Estimated Earnings (Weekly) = $<span class="weekly"></span></h5>
                                                                        ...
                                                                        <div class="tab">
                                                                            ...
                                                                            <div class="tab">
                                                                                ...
                                                                                <div>
                                                                                    <input type="date" name="insurance_exp" id="registration_exp">
                                                                                </div>
                                                                                <h4>Inspection:</h4>
                                                                                <input type="file" id="inspection" name="inspection" accept="image/*">
                                                                                <div>
                                                                                    <input type="date" name="inspection_exp" id="registration_exp">
                                                                                </div>
...
<script>
    ...
    <script>
        function createRecord(){
            ...
            $.ajax({
                url: getBaseUrl() + "/user/transport/addcar",
                headers: {
        ...
        $('#vin').change(function(){
            ...
            $.ajax({
                type:"POST",
                url: getBaseUrl() + "/user/transport/vin-details",
                data: {vin: vin},
                headers: {
                    Authorization: "Bearer " + getToken("owner")
                },
                success:function(response){
                    ...
                    $('#year').val(data.ModelYear);
                    $('#capacity').val(data.Seats);
                }
            });
        });


    $('#daily_charges, #weekly_charges').keyup(function(){
        ...
        $.ajax({
            ...
            success:function(data){
                    var admincharges=data.responseData;
                    var insurance_fee = admincharges.insurance_fee;
                    var booking_fee = admincharges.booking_fee;
                    var sales_tax = admincharges.sales_tax;
                    var charge = parseInt(booking_fee)+parseInt(insurance_fee);


                    var input1 = $('#daily_charges').val();
                    var input2 = $('#weekly_charges').val();

                    var dailycharge = parseInt(input1)-((parseInt(input1)/100)*parseInt(sales_tax)+charge);
                    var weeklycharge = parseInt(input2)-((parseInt(input2)/100)*parseInt(sales_tax)+charge);

                    if(input1!=''){
                        $('.daily').text(dailycharge);
                    }

                    if(input2!=''){ 
                        $('.weekly').text(weeklycharge);
                    }
            }
        });
    });
