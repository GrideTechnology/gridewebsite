      ...
      <div id="password-change" class="col-sm-12 col-md-12 col-lg-12 dis-column">
         ...
         <div class="h-100 col-sm-12 col-md-12 col-lg-12 dis-column">
            <main class="">
               ...
               <div class="mt-2">
                  <a href="{{url('owner/login')}}" id="sign" class="txt-secondary sign-up-link"><i class="fa fa-arrow-circle-left mr-2" aria-hidden="true"></i>@lang('auth.back_to_login')</a>
               </div>
            </main>
         </div>
      </div>
...
$(document).ready(function() {
   ...
   $('.validateForm').validate({
      ...
      submitHandler: function(form) {
            ...
            $.ajax({
               url: getBaseUrl() + "/user/owner/reset/otp",
               type: "post",
               data: data,
               processData: false,
               contentType: false,
