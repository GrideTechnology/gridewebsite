        ...
        <form class="validateForm" files="true">
                ...
                <div class="form-row">
                    ...
                    <label for="item_discount_type">@lang('store.admin.item.discount_type')</label>
                      <select class="form-control" name="item_discount_type" id="item_discount_type">
...
$(document).ready(function()
{
   ...
   if($("input[name=id]").length){
    ...
    $(document).on('change',"#item_discount_type",function (e) {
        var optVal= $("#item_discount_type").val();
        if(optVal == 'PERCENTAGE'){
            $('#item_discount').attr({
                "max" : 100,
                "min" : 0
            });
        }else{
            $('#item_discount').removeAttr('max');
