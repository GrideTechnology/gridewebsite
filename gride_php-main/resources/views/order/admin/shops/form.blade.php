...
<div class="row mb-4 mt-20">
    <div class="col-md-12">
        ...
        <form class="validateForm" files="true"> 
                ...
                <input type="hidden" class="form-control" id="store_gst" name="store_gst" placeholder="{{ __('store.admin.shops.gst') }}" value="0" >
                <input type="hidden" class="form-control decimal" id="commission" name="commission" placeholder="{{ __('store.admin.shops.commission') }}" value="0" >
                {{--  <div class="form-row">
                    <div class="form-group col-md-6">
