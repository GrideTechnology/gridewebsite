...
<html class="no-js h-100" lang="en">
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/plugins/chart/css/export.css')}}"/>
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/plugins/extras/css/extras.min.css')}}">
      <link rel="stylesheet" type='text/css' href="{{ asset('assets/plugins/intl-tel-input/css/intlTelInput.min.css')}}" />
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/layout/css/admin-style.css')}}">
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/layout/css/dashboards.min.css')}}">
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/plugins/lightgallery/css/lightgallery.css') }}">
       @show
   ...
   {{--  <div class="loader-container">
      ...
      <script src="{{ asset('assets/plugins/lightgallery/js/lightgallery.js') }}"></script>
      <script src="{{ asset('assets/plugins/lightgallery/js/lg-fullscreen.js') }}"></script>
      <script src="{{ asset('assets/plugins/lightgallery/js/lg-zoom.js') }}"></script>
      ...
      <script>
         ...
         //if("{{Session::get('user_id')}}" == "") {
            $.ajax({
               url: getUrl() + "/admin/permission_list/"+adminSettings.id+"/token/"+getToken("admin"),
               type: "get",
               processData: false,
               contentType: false,
...
// });
        ...
        $(document).find("title").text(site_name+' '+current_title);
         ...
         $('body').on('click', '.delete-record', function() {
            ...
            var sab_url = $(this).data('sab_url');

            $(".delete-modal").modal("show");
            $(".delete-modal-btn").off().on("click", function() {
                  var url = getBaseUrl() + sab_url;
                  $.ajax({
                     type:"DELETE",
                     url: url,
                     headers: {
