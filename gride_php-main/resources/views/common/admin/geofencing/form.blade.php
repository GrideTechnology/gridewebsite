...
<script>
    ...
    function initMap(current_latitude = 13.0574400, current_longitude = 80.2482605) {
    ...
    $(document).ready(function()
    {
        ...
        $('select[name=city_id]').on('change', function(){
            if($(this).val() != "") {
                ...
                var city = $("#city_id :selected").map(function(i, el) {
                                return $(el).text();
                            }).get().toString();;
...
function loadData() {
    ...
    $.ajax({
        ...
        success:function(response){
            ...
            setTimeout(() => {
                $('#city_id').val(data.responseData.city_id);
