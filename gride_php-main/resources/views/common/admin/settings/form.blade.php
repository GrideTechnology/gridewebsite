...
<?php
        ...
        if ($config_file) {
            ...
            try {
                ...
                $result = $client->post(config('gride.BASE_URL') . '/verify', $params);
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <div class="form-row">
                         ...
                         <div class="form-row">
                            <div class="col-xl-6">
                                <label for="store_instagram_link" class="col-xs-3 col-form-label">@lang('admin.setting.Instagram_Link')</label>
                                <input class="form-control" type="text" value="{{ Helper::getSettings()->site->store_instagram_link  }}" name="store_instagram_link" id="store_instagram_link" placeholder="@lang('admin.setting.Instagram_Link')">
                            </div>
                            
                            <div class="col-xl-6">
                                <label for="store_youtube_link" class="col-xs-3 col-form-label">@lang('admin.setting.Youtube_Link')</label>
                                <input class="form-control" type="text" value="{{ Helper::getSettings()->site->store_youtube_link  }}" name="store_youtube_link" id="store_youtube_link" placeholder="@lang('admin.setting.Youtube_Link')">
                            </div>
                        </div>
                        
                        <div class="form-row">
                            <div class="col-xl-6">
                                <label for="store_linkedin_link" class="col-xs-3 col-form-label">@lang('admin.setting.Linkedin_Link')</label>
                                <input class="form-control" type="text" value="{{ Helper::getSettings()->site->store_linkedin_link  }}" name="store_linkedin_link" id="store_linkedin_link" placeholder="@lang('admin.setting.Linkedin_Link')">
                            </div>
            ...
            <div id="transport" class="row setup-content edu_form form_bdy">
                <div class="col-xs-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="ride_search_radius" class="col-xs-3 col-form-label">@lang('admin.setting.Provider_Search_Radius') (Miles)</label>
                            <div class="col-xs-9">
                        ...
                        <!-- <div class="form-group"> -->
                            ...
                            <input type="hidden" name="unit_measurement" value="Miles"/>
                            <!-- <div class="col-xs-9">
                        ...
                        <div class="form-group">
                            <label for="customToggle_geofence">{{ __('Geofence') }}</label>
                            <br>
                            <div class="custom-control custom-toggle">
                                <input {{Helper::getSettings()->transport->geofence == '1' ? 'checked' : ''}} type="checkbox" value="1" id="customToggle_geofence" name="geofence"  class="custom-control-input" >
                                <label class="custom-control-label" for="customToggle_geofence"></label>
                            </div>
                        </div>
            ...
            <div id="service" class="row setup-content edu_form form_bdy">
                <div class="col-xs-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label for="service_search_radius" class="col-xs-3 col-form-label">@lang('admin.setting.Provider_Search_Radius') (Miles)</label>
                            <div class="col-xs-9">
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control " type="text" value="<?php echo isset(Helper::getSettings()->site->country_code)? Helper::getSettings()->site->country_code :'us'; ?>" name="country_code" required id="country_code" placeholder="@lang('admin.setting.Country_code')">
                            </div>
                        </div>
