    ...
    <div class="col-md-12">
        ...
        <div class="form_pad">
            <form class="validateForm" files="true">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6 ">
                        <label for="licence_number" class="col-xs-2 col-form-label">Licence Number</label>
                        <input type="text" class="form-control licence_number" id="licence_number" name="licence_number" placeholder="Licence Number" value="">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="licence_verified">Licence Approval</label>
                            <select name="licence_verified" id="licence_verified" class="form-control">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="image-placeholder w-100">
                            ...
                            <input type="file" name="licence_front" class="upload-btn picture_upload">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="image-placeholder w-100">
                            <img width="100" height="100" />
                            <input type="file" name="licence_back" class="upload-btn picture_upload">
                        </div>
                    </div>
                </div>
                <div class="form-row">
...
$(document).ready(function()
{
    ...
    $('.picture_upload').on('change', function(e) {
        ...
        if (files && files.length > 0) {
            if(obj.attr('name') == 'licence_front') {
                licence_front = files[0].name;
            } else if(obj.attr('name') == 'licence_back') {
                licence_back = files[0].name;
            } else if(obj.attr('name') == 'picture1') {
