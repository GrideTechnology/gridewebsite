        ...
        <div class="form_pad">
            <form class="validateForm">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="picture" class="col-xs-2 col-form-label">{{ __('admin.document.document') }}</label>
                        <div class="document-placeholder w-100">
                            <img class="pdf" id="add_document" src="{{ asset('assets/layout/images/common/svg/pdf-file.svg') }}" alt="add_document">
                            <span id="document_name" ></span>
                        </div>
                        <input type="file" id="document_upload_btn"  class="upload"  accept="application/pdf">
                    </div>
                </div>
...
$(document).ready(function()
{
    ...
    $('.document-placeholder').on('click', function(e) {
        $('#document_upload_btn').trigger('click');
    });

    $('#document_upload_btn').on('change', function(e) {
      docs = e.target.files[0];
      $("#document_name").html(docs.name);
    });
    ...
    $('.cancel').on('click', function(){
     ...
     $('.validateForm').validate({
		...
		submitHandler: function(form) {
            ...
            if(docs != "") data.append('provider_document_url', docs);
