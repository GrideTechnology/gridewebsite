        ...
        <div class="form_pad">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label><b style ="font-weight:bold">{{ __('Provider Name') }}ss:</b> <span class="m-0 provider_name"></label>
                    </div>
                    <div class="form-group col-md-6">
                        <label><b style ="font-weight:bold">{{ __('Document Name') }}ss:</b> <span class="m-0 document_name"></label>
                    </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <ul class="small-block-grid-2 medium-block-grid-3" id="img_doc">
                        <li data-src="" id="img_doc_src">
                           <a href="">
            ...
            success:function(data){
                ...
                $.each(result,function(key,item){
                    ...
                    if(str1.indexOf(str2) != -1){
                        ...
                        document.getElementById("img_doc_src").setAttribute('data-src', item.url[0].url);
                    }
                    ...
                    $(".backend_iamge").empty().append(`<p>BackSide Image</p><ul class="small-block-grid-2 medium-block-grid-3"  id="img_doc_1"><li data-src="`+item.url[1].url+`" id="img_doc_1_src"><a href=""><img src = "`+item.url[1].url+`" class ="img1" height ="200px;" width ="200px;" /> </a></li></ul> `);
                    ...
                    lightGallery(document.getElementById('img_doc'), {
                        download: false,
                        share: false,
                    });

                    lightGallery(document.getElementById('img_doc_1'), {
                        download: false,
                        share: false,
                    });
                });
