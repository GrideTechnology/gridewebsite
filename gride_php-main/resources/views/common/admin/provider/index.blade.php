                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <div class=" m-0 front_image1" style =margin-left:100px;>
                                             ...
                                             <ul class="small-block-grid-2 medium-block-grid-3" id="img">
                                                 <li data-src="" id="img_src">
                                                    <a href="">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <ul class="small-block-grid-2 medium-block-grid-3"  id="img1">
                                                <li data-src="" id="img1_src">
                                                   <a href="">
               ...
               // console.log(data);
                ...
                var button='<div class="input-group-btn action_group"> <li class="action_icon"> <button type="button"class="btn btn-info btn-block "data-toggle="dropdown"><i class="fa fa-ellipsis-v" aria-hidden="true" title="View"></i></button>'+
                       ...
                       if(data.status=="APPROVED"){
                        ...
                        button +='<li><a href="javascript:;" data-id="'+data.id+'" data-value="'+data.status+'" data-sab_url="/admin/provider/'+data.id+'" class="dropdown-item delete-record"><i class="fa fa-trash"></i>&nbsp;Delete</a> </li>';
                        button +='</ul> </li></div>';
                     return  button;
