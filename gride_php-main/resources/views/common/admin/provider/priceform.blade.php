         ...
         var servicenames='';
             if(providerdetails.providerservice.length > 0 ){
               ...
               $.each(services,function(k,servicename){
                servicenames += `<a href="javascript:;" class="list-group-item cityActiveClass" onclick="getData('`+servicename+`')" ><span>`+servicename.charAt(0).toUpperCase()+servicename.slice(1).toLowerCase()+`</span></a>`;
               });
            ...
            $('.myprice').empty().append(`<div class="form-group">
                        ...
                        <div class="list-group">
                         ...
                         <a href="javascript:;" class="list-group-item cityActiveClass" onclick="getData('ALL')" ><span>Common Document</span></a>
                         <a href="javascript:;" class="list-group-item cityActiveClass" onclick="getData('zone')" ><span>Zone</span></a>    
                         <a href="javascript:;" class="list-group-item cityActiveClass" onclick="overall_approval()"><span>Provider Approve</span></a>    
                        </div>
                        </div>
                   </div>
            `   );
...
function getData(service){
 ...
 $(document).on('click', '.view_vechile', function(){
  ...
  if(model_name=="ORDER"){
    ...
    document.getElementById("img_src").setAttribute('data-src', vechile_details[vechile_id].picture);
    document.getElementById("img1_src").setAttribute('data-src', vechile_details[vechile_id].picture1);

    $(".vechiledetails").modal("show");

    lightGallery(document.getElementById('img'), {
        download: false,
        share: false,
    });

    lightGallery(document.getElementById('img1'), {
        download: false,
        share: false,
    });
