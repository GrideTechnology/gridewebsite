...
<style>
    ...
    .crudModal_tbl div#data-tables_wrapper {
        display: block;
    }
    .crudModal_tbl .form-inline label {
        align-items: center;
        ...
        "columns": [
            ...
            { "data": "id", render: function (data, type, row) {
                    ...
                    var button='<div class="input-group-btn action_group"> <li class="action_icon"> <button type="button"class="btn btn-info btn-block "data-toggle="dropdown"><i class="fa fa-ellipsis-v" aria-hidden="true" title="View"></i></button>'+
                       ...
                       button +='<li><a href="javascript:;" data-id="'+data+'" class="dropdown-item edit"><i class="fa fa-edit"></i> Edit</a> </li>';
                       button +='<li><a href="javascript:;" data-id="'+data+'" data-sab_url="/admin/menu/'+data+'" class="dropdown-item delete-record"><i class="fa fa-trash"></i>&nbsp;Delete</a> </li>';
                        button +='</ul> </li></div>';
                     return  button;
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            countryCityList +=  `<a class="list-group-item citylist" href="#" onclick="getData(`+id+`,'ALL','ALL')"><span>All Countries</span></a>`;
                ...
                countryCityList +=  `<a class="list-group-item countrylist `+ countryActiveClass +` citylist`+value.country.id+`" href="#"  onclick="getData(`+id+`,`+value.country.id+`,'`+value.country.country_name+`')" id="`+value.country.id+`"><span>`+value.country.country_name+`</span></a>`;
...
$('body').on('change', '#country_list', function() {
    ...
    if( country_id != ''){
        getData(price_id,country_id,text)
    }
});
