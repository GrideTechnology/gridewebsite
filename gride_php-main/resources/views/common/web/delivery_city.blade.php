...
<header>
    <div>                         
    <h2><b>Grocery Delivery in <c class="user_city"></c></b></h2>
 ...
 <section class="food-delivery">
    ...
    <p>Have your favorite food delivered in <c class="user_city"></c> with Gride. Gride makes it easy to discover new and nearby places to eat in <c class="user_city"></c>, whether <br> you want to order groceries or snacks. Browse from the many food delivery options, place your order, and track it instantly.</p>
 </section>
...
//              $('.user_city').text(response.responseData.city_name);
//              //listMenus(id);
//             // $('#search-city').val("");
//           },
