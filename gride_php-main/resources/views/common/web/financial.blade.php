...
@section('content')
  ...
  <div class="container">
      <!-- Trigger the modal with a button -->
      <!-- Modal -->
      <div id="gaurav" class="modal fade" role="dialog">
          <div class="modal-dialog modal-lg">
              <!-- Modal content-->
              <div class="modal-content">
                  <div class="modal-header">
                  ...
                  <div class="modal-body">
                      <div class="row">
                          <div class="col-md-12 ml-auto">
                            @foreach(Helper::getcmspage() as $k=>$v)
                              @if($v->page_name == 'financial_gaurav')
                                  {!!$v->content !!}
                              @endif
                            @endforeach
                          </div>
   ...
   <div class="container">
      <!-- Trigger the modal with a button -->
      <!-- Modal -->
      <div id="salvador" class="modal fade" role="dialog">
          <div class="modal-dialog modal-lg">
              <!-- Modal content-->
              <div class="modal-content">
                  <div class="modal-header">
                  ...
                  <div class="modal-body">
                      <div class="row">
                          <div class="col-md-12 ml-auto">
                            @foreach(Helper::getcmspage() as $k=>$v)
                              @if($v->page_name == 'financial_salvador')
                                  {!!$v->content !!}
                              @endif
                            @endforeach
                          </div>
