...
@include('common.user.includes.header')
    ...
    <section class="services-list">
        <div class="result-show">
                ...
                <input type="text" name="search-city" placeholder="Search City " class="col-xl-2 col-md-4" id="search-city">
      ...
      $.ajax({
         ...
         success: (response, textStatus, jqXHR) => {
            ...
            result.forEach(function(item, index){
                  ...
                  if(item.admin_service == 'TRANSPORT') {
                     url = "{{ url('/user/ride') }}";
                  }
                 
                  if(item.admin_service == 'ORDER') {
                     url = "{{ url('/user/store/list') }}";
                  }
                  //Display menu in home page(With color and image)
                  if(item.admin_service  == 'TRANSPORT') {
                     $('#rides').append(`<a href="`+ url + `/` + item.menu_type_id +`/transport" ><div class="service-list col-md-3 col-lg-2 col-sm-12 p-0">
                        <div class="service-item item-shadow" style="background-color:`+ item.bg_color +`">
                        <img alt="" class="img-responsive" src="`+ item.icon +`">
                        <div class="blog-hover"></div>
                        </div>
                        <div class="service-section">
                        <div class="service-content">
                              <h3 class="service-title">`+ item.title +`</h3>
                                 <a href="`+ url + `/` + item.menu_type_id +`/transport" class="link-arrow">Book Now<i class="icon ion-ios-arrow-right"></i></a>
                        </div>
                        </div>
                     </div></a>`);
                  }
                  if(item.admin_service == 'RENTAL') {

                     $('#rides').append(`<a href="{{url('/')}}/user/rental/booking" ><div class="service-list col-md-3 col-lg-2 col-sm-12 p-0">
                        <div class="service-item item-shadow" style="background-color:`+ item.bg_color +`">
                        <img alt="" class="img-responsive" src="`+ item.icon +`">
                        <div class="blog-hover"></div>
                        </div>
                        ...
                        <div class="service-content">
                              <h3 class="service-title">Rental</h3>
                                 <a href="{{url('/')}}/user/rental/booking" class="link-arrow">Book Now<i class="icon ion-ios-arrow-right"></i></a>
                        </div>
                        </div>
                     </div></a>`);
                  }
                  if(item.admin_service == 'ORDER') {
                     var userSettings = getUserDetails();
                     $('#rides').append(`<a href="`+ url + `/` + item.menu_type_id +`?city_id=`+userSettings.city_id+`" ><div class="service-list col-md-3 col-lg-2 col-sm-12 p-0">
                        <div class="service-item item-shadow" style="background-color:`+ item.bg_color +`">
                        <img alt="" class="img-responsive" src="`+ item.icon +`">
                        <div class="blog-hover"></div>
                        </div>
                        ...
                        <div class="service-content">
                              <h3 class="service-title">`+ item.title +`</h3>
                                 <a href="`+ url + `/` + item.menu_type_id +`?city_id=`+userSettings.city_id+`" class="link-arrow">Book Now<i class="icon ion-ios-arrow-right"></i></a>
                        </div>
                        </div>
                     </div></a>`);
                  }
                  if(item.admin_service == 'SERVICE') {
                     $('#rides').append(`<div class="service-list col-md-3 col-lg-2 col-sm-12 p-0">
                        <div class="service-item item-shadow" style="background-color:`+ item.bg_color +`">
                        <img alt="" class="img-responsive" src="`+ item.icon +`">
                        <div class="blog-hover"></div>
                        </div>
                        <div class="service-section serviceBlock" id =category_id data-id =`+ item.menu_type_id +`>
                        <div class="service-content">
                              <h3 class="service-title">`+ item.title +`</h3>
   ...
   $(document).ready(function(){
      $('#search-city').autocomplete({
            source: function(request, response) {
                  $.ajax({
                        url: getBaseUrl() + "/user/search-cities",
                        type: "post",
                        dataType: "json",
                        data:{
            ...
            select: function(event, ui) {
               ...
               value =  ui.item.label;
               $('#search-city').attr("data-id", city_id);
