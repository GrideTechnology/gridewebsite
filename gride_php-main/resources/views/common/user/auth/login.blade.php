            ...
            <div class="dis-center">
               ...
               <form class=" h-100 col-sm-12 col-md-12 col-lg-12 col-xl-12 dis-column validateSignForm">
                    ...
                    <label>Gender</label>
                     ...
                     <label>State</label>
                     <select name="state_id" id="state_id" class=" mb-4 form-control">
                        <option value="">Select State</option>
                     </select>
                     <label>City</label>
                     <select name="city_id" id="city_id" class=" mb-4 form-control">
                     ...
                     <label class="mt-4" >Referral Code</label>
                     <input id="referral_code" name="referral_code" class="form-control" placeholder="Referral Code" type="text" >
                     </div>
                     @if(Helper::getSettings()->site->send_sms == 1)
...
$('#state_id').change(function(){
   ...
   $.ajax({
        type:"GET",
        url: getBaseUrl() + "/user/citybystate/"+id,
        'beforeSend': function (request) {
            showInlineLoader();
        },
        success:function(data){
