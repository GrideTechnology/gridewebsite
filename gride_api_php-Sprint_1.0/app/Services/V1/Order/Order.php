    ...
    public function cancelOrder($request) {
        ...
        try{
            ...
            if(!empty($card)){
                ...
                {
                    return ['status' => 404, 'message' => trans('api.order.order_can_not_cancelled')];
                }
                ...
                // if(in_array($orderRequest->status, ['ORDERED','STORECANCELLED'])) {
                    ...
                    $orderInvoice->cancellation_fee =  $cityprice->cancellation_fee;
                    if(!empty($orderRequest->provider_id)){
                        ...
                        $request['type']='C';
                        $request['amount']=$cityprice->cancellation_fee;
