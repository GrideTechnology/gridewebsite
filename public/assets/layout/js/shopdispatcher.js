                            ...
                            {requests.map((request) =>
                                <div key={request.id} onClick={ this.handleClick.bind(this, request) } className="bg-white m-lr-20 shadow-sm">                                                                    
                                    ...
                                    <div className="p-2">
                                        ...
                                        <p className="font_14">Payment: { request.invoice !== null ? request.invoice.payment_mode : '' }</p>
                                   ...
                                   <div className="modal-header">
                                    ...
                                    <div className="form-group col-md-6">
                                        ...
                                        {(() => {
                                            ...
                                            case 'FOOD':  
                                                return <div> 
                                                             <label htmlFor="first_name">Cooking Time (Minutes) </label> <input type="hidden" className="form-control" id="store_order_id"  name="id"  value={accept.store_order_id}  /><input type="number" className="form-control" id="order_ready_time" placeholder="Cooking Time" min="0" name="cooking_time" onChange={this.handleChange} value={accept.cooking_time}  /> 
